...
3. If the work changed architecture, conventions, tooling, operational behavior, or canonical project commands, update the relevant `.agents/bundles/knowledge/*.md` chapter and `.agents/bundles/knowledge/workflow.md`.
