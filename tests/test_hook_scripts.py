...
def test_manifest_targets_resolve_to_direct_emitters() -> None:
    ...
    for manifest in MANIFESTS:
        ...
        for command in commands:
            ...
            matches = re.findall(
                r"hooks/(session-start|cursor-session-start|agy-pre-invocation|block-dangerous-git)\.(sh|ps1|js|cmd)",
                command,
            )
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "g'i't push --force origin main",
        'g""it push --force origin main',
        "env g'i't push --force origin main",
        "/usr/bin/g'i't push --force origin main",
        "printf safe | git push --force origin main",
        "make lint && g'i't push --force origin main",
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ('git commit -m "' + "word " * 4000 + '" && git push --force origin main', 2),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        '"${CMD}" push --force origin main',
        "/usr/bin/g?t push --force origin main",
        "./[g]it push --force origin main",
        r"g\it push --force origin main",
        "$'git' push --force origin main",
        'bash -c "$CMD push --force origin main"',
        'eval "$CMD push --force origin main"',
        'timeout 5 bash -c "$CMD push --force origin main"',
