...
`hatch-mojo` is available at `https://github.com/cofin/hatch-mojo`.
...
Use `uv publish` for publishing completed wheels. Current standards prefer OIDC authentication.
...
2. Project README: `https://github.com/cofin/hatch-mojo#readme`
