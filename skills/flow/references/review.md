...
2. **Read Project Context:** recursively read relevant `.agents/bundles/knowledge/patterns/**/*.md` chapters
...
4. **Conventions:** From recursively relevant `.agents/bundles/knowledge/patterns/**/*.md` chapters
